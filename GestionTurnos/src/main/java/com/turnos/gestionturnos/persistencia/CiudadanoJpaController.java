...
import com.turnos.gestionturnos.persistencia.exceptions.NonexistentEntityException;
...
public class CiudadanoJpaController implements Serializable {
    ...
    //Constructor predeterminado que crea un emf utilizando la unidad de persistencia "gestionturnosPU"
    ...
    public Ciudadano findCiudadanoDni(String dni) {
        EntityManager em = getEntityManager();
        try {
            ...
            return null; // Retorna null si no se encuentra ningún ciudadano con ese DNI
        } finally {
            em.close();
        }
    }
